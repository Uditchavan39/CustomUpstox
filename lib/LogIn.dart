...
class _AuthorizationState extends State<Authorization> {
  ...
  final authorizationEndpoint =
      Uri.parse('https://api-v2.upstox.com/login/authorization/dialog')
...
class _AccessTokenState extends State<AccessToken> {
  ...
  @override
  Widget build(BuildContext context) {
    return const MyHomePage(title: "My Upstox");
  }

  late Map<String, dynamic> parsed;
  void access() async {
    final access_token =
        Uri.parse('https://api-v2.upstox.com/login/authorization/token')
            .replace(queryParameters: {
