...
class _splash_screenState extends State<splash_screen> {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: SplashScreen(
        seconds: 3,
        navigateAfterSeconds: (access_token && date_match)
            ? const MyHomePage(
                title: "Custom Upstox",
              )
            : const Authorization(),
        ...
        image: Image.asset('assets/fluttericon.png',alignment: Alignment.bottomCenter,),
        backgroundColor: const Color.fromARGB(255, 229, 201, 234),
