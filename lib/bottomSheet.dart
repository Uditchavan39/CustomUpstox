...
class bottomSheet extends StatefulWidget {
  bottomSheet(
      ...
      this.financialYear, this.TotalBuy, this.TotalSell, this.TotalCharges});
  final index;
  final financialYear;
  final TotalBuy;
  final TotalSell;
        ...
        body: widget.bslist.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  if(index==widget.bslist.length) return  CustomDataBottomsheetrow(Totalbuy: widget.TotalBuy,Totalsell: widget.TotalSell,Totalcharges: widget.TotalCharges,TotalReturn: TotalReturn,);
